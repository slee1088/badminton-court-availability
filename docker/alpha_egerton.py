...
#page.get_by_text("Alpha Egerton (28 Courts)").click()
...
for i in range(4):
    ...
    page.wait_for_timeout(2000)
    week = i + 1
    #html_name = 'egerton_week_' + str(week) + '.html'
...
split_schemas = split_html_by_date(egerton_bookings)
...
df_union_final = df_union_final[df_union_final['Location'] == 'Alpha Egerton']
...
date_time_df['Location'] = 'Alpha Egerton'
...
#df_union_final.to_csv('alpha_egerton_bookings.csv', index=False)
#print(df_union_final)

bucket_name = "badminton-bookings"
blob_name = "alpha_egerton_bookings.csv" 
