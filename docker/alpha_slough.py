...
split_schemas = split_html_by_date(slough_bookings)
...
df_union_final = df_union_final[df_union_final['Location'] == 'Alpha Slough']
...
date_time_df['Location'] = 'Alpha Slough'
...
#df_union_final.to_csv('alpha_slough_bookings.csv', index=False)
#print(df_union_final)


bucket_name = "badminton-bookings"
blob_name = "alpha_slough_bookings.csv" 
