...
page.goto('https://kbcnsw.yepbooking.com.au/')
...
df_union_final['Location'] = 'KBC Rydalmere'
...
date_time_df['Location'] = 'KBC Rydalmere'
...
blob_name = "kbc_rydalmere_bookings.csv" 
